...
<?php
	...
	include('conn.php');
	$id=$_GET['id'];
	$query=mysqli_query($conn,"SELECT * FROM `proditems` where productid='$id'");
...
<html>
    <head>
    <title>Edit | Inventory Management System</title>
            ...
            <div class="header-inner">
                ...
                <div class="nav-menu">
                    <ul class="nav-menu-inner">
                        ...
                        <li>
                              <a><button type="button" class="btn btn-success">Employee</button></a>
                        </li>
                        </li>
                        <span class="nav-link"></span>
                           <li>                      
                        <li>
                        	<a class="" href="inventory.php">Back</a>
...
<body>
	...
	<form method="POST" action="update.php?id=<?php echo $id; ?>">
		<label>Product Name</label><input type="text" value="<?php echo $row['product']; ?>" name="product">
		<label>Size</label><input type="text" value="<?php echo $row['size']; ?>" name="size">
		<label>Quantity&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input type="text" value="<?php echo $row['stock']; ?>" name="stock">
		<label>Price</label><input type="text" value="<?php echo $row['price']; ?>" name="price">
		<input type="submit" name="update" class="btn btn-md btn-black" value="update">
                    ...
                    <div class="col-md-6">
                        <div class="border-box">
                            ...
                            <p>This page is used for editing data of a product.</p>
