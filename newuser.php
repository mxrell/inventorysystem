...
<html>
    <head>
    <title>Add Account | Inventory Management System</title>
...
<html>
    ...
    <body>  
        ...
        <form method="POST" class="register-form" id="register-form" action="newuser.php">
        ...
        <br><input type="password" name="password_2" id="password_2"required="_required" placeholder="Confirm password"/>
        <br><select name="acctype">
            <option value="user">User</option>
            <option value= "admin">Admin</option>
        </select>
        <br><input type="submit" name="reg_user" id="reg_user" class="btn btn-md btn-black" value="submit"/>
                    ...
                    <div class="col-md-6">
                        <div class="border-box">
                            ...
                            <p> This page is used for creating new account.</p>
            ...
            <section class="copyright ptb-15">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-sm-6 text-right text-sm-left"><a target="_blank" href="h"><b></b></a></div>
                    </div>
                </div>
            </section>
            <!-- End Copyright Bar -->
