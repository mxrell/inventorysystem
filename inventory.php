...
<html>
    <head>
    <title>Employee | Inventory Management System</title>
            ...
            <div class="header-inner">
                ...
                <div class="nav-menu">
                    <ul class="nav-menu-inner">
                        ...
                        <li>
                            <a class=""href="inventory.php?logout='1'" onclick="return  confirm('Are you sure you want to log out?')">Log Out</a>
                        </li>
                         ...
                         <tbody>
                              ...
                              ?>                                                 
                                             <tr class="table-light">  
                                                  ...
                                                  <th scope="row"><?php echo $row['size']; ?></th> 
                                                  <th scope="row"><?php echo $row['stock']; ?></th>
                                   ...
                                   else
                                   {
                                        ...
                                        <form action="" method="GET">
                                             ...
                                             <button type="submit"class="btn btn-md btn-black">Filter</button><br></br>                      
                                        </form>                               
                         </tbody>
                    </tr>
               </table>
